...
import { FolderPlus, KeyRound, Link2, MessageCircle, Users } from "lucide-react";
      ...
      <div className="relative flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <p className="mt-2 max-w-sm text-sm leading-relaxed text-nova-navy/45">
            Aún no perteneces a ningún grupo. Crea uno o únete con un código para empezar a colaborar con tus
            compañeros.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-2 lg:justify-start">
            <span className="flex items-center gap-1.5 rounded-full bg-nova-navy/[0.03] px-3 py-1.5 text-[11px] font-medium text-nova-navy/50">
              <MessageCircle className="h-3.5 w-3.5 text-nova-electric/70" strokeWidth={1.75} />
              Chat en tiempo real
            </span>
            <span className="flex items-center gap-1.5 rounded-full bg-nova-navy/[0.03] px-3 py-1.5 text-[11px] font-medium text-nova-navy/50">
              <Link2 className="h-3.5 w-3.5 text-nova-electric/70" strokeWidth={1.75} />
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-2.5 lg:justify-start">
            <motion.button
              ...
              className="flex items-center gap-2 rounded-full border border-nova-navy/10 px-5 py-2.5 text-xs font-medium text-nova-navy/70 transition-colors hover:bg-nova-navy/[0.03]"
            >
        ...
        <div className="relative flex h-36 w-36 shrink-0 items-center justify-center sm:h-40 sm:w-40">
          ...
          />
          <Users className="relative h-12 w-12 text-nova-electric sm:h-14 sm:w-14" strokeWidth={1.5} />
          <motion.span
            aria-hidden="true"
